...
import { AboutContainer, Container, HelloText, ArrowContainer, WorkText } from './styles/hello'
...
export default function Hello() {
  return (
    <Container>
        ...
        <AboutContainer><img height={"50%"} src={"/image_scaleddown.jpg"}/><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p></AboutContainer>
        <ArrowContainer><svg width="18" height="53" viewBox="0 0 18 53" fill="none" xmlns="http://www.w3.org/2000/svg">
